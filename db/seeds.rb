...
#Creates 5 cars
car1 = Car.create! :user_id => 1, :seats => 5, :licence => "10234", :fuel_consumption => 5.5, :smoker => true, :description => "Kein Kofferraum", :car_type => "BMW"
car2 = Car.create! :user_id => 2, :seats => 2, :licence => "40321", :fuel_consumption => 6.7, :smoker => false, :description => "Kofferraum verfügbar aber kein Platz", :car_type => "Mercedes"
car3 = Car.create! :user_id => 3, :seats => 3, :licence => "12345", :fuel_consumption => 8.9, :smoker => true, :description => "Auto rostet und keine Reifen", :car_type => "Ford"
car4 = Car.create! :user_id => 4, :seats => 4, :licence => "54321", :fuel_consumption => 11.1, :smoker => false, :description => "Test test", :car_type => "Porsche"
car5 = Car.create! :user_id => 5, :seats => 2, :licence => "45646", :fuel_consumption => 20.3, :smoker => true, :description => "aha aha! Hier soll etwas sinnvolles stehen?", :car_type => "VW"
#Creates 5 messages
...
", :writer_id => 1, :receiver_id => 2, :delete_writer => false, :delete_receiver => false, :subject => "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
...
Das Interesse an korrekter Rechtschreibung sei ungebrochen hoch: Nur 15 Prozent halten sie für überflüssig, dagegen ist sie für 85 Prozent der Befragten wichtig. ", :writer_id => 5, :receiver_id => 1, :delete_writer => true, :delete_receiver => false, :subject => "Prominente Bankdrücker bei Bayer Leverkusen: die" 
...
Michel Massing", :writer_id => 1, :receiver_id => 4, :delete_writer => true, :delete_receiver => false, :subject => "Das tapfere Schneiderlein gab die Vorlage zum Duell zwischen Eintracht Braunschweig und dem FC Bayern München,"
...
Gunnar Beuth
", :writer_id => 1, :receiver_id => 5, :delete_writer => true, :delete_receiver => false, :subject => "Somit gab es keine neue Pokalsensation und die Gewissheit, dass eine gute Geschichte noch lange nicht"
...
l", :writer_id => 2, :receiver_id => 1, :delete_writer => true, :delete_receiver => false, :subject => "Somit gab es keine neue Pokalsensation und die Gewissheit,"
