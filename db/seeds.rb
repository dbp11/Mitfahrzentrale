...
user1 = User.create! :email => "ahaahja@gmx.com", :password => "fneffensef",:password_confirmation => "fneffensef", :name => "rgdrggrdg", :user_type => true, :sex => true, :address => "ragkagr nrgsjg grgdg 454", :addressN => 4, :addressE => 4, :zipcode => 1564, :phone => 1231464, :instantmessenger => "grdgd", :city => "sgrsgg", :email_notifications => true, :visible_phone => true, :visible_email => true, :visible_address => true, :visible_age => true, :visible_im => false, :visible_cars => true, :birthday => Time.now, :role => "fesfse", :visible_zip => true
