...
car1 = Car.create! :user_id => 1, :seats => 5, :licence => 1234, :fuel_consumption => 5.5, :smoker => true, :description => "Kein Kofferraum"
car2 = Car.create! :user_id => 2, :seats => 2, :licence => 4321, :fuel_consumption => 6.7, :smoker => false, :description => "Kofferraum verfügbar aber kein Platz"
...
tri1 = Trip.create! :user_id => 1, :car_id => 1, :starts_at_N => 54, :starts_at_E => 12, :ends_at_E => 33, :ends_at_N => 32, :address_start => "aha straße 2 ahahausen 32323", :address_end => , :start_time => , :comment => , :baggage =>
...
user1 = User.create! :email => "ahaahja@gmx.com", :encrypted_password => "fneffensef", :name => "rgdrggrdg", :user_type => true, :sex => true, :address => "ragkagr nrgsjg grgdg 454", :addressN => 4, :addressE => 4, :zipcode => 1564, :phone => 1231464, :instantmessenger => "grdgd", :city => "sgrsgg", :email_notifications => true, :visible_phone => true, :visible_email => true, :visible_address => true, :visible_age => true, :visible_im => false, :visible_cars => true, :birthday => Time.now, :role => "fesfse", :visible_zip => true
user2 = User.create! :email => "ahfwef@aol.com", :encrypted_password => "gdsgrgrg", :name => "rdgggrdg", :user_type => false, :sex => false, :address => "ragkagr nrgsjg grgdg 454"   , :addressN => 3, :addressE => 5, :zipcode => 4564645, :phone => 456465, :instantmessenger => "grggrgrd", :city => "rsgsgr", :email_notifications => false, :visible_phone => true, :visible_email => false, :visible_address => false, :visible_age => true, :visible_im => false, :visible_cars => true, :birthday => Time.now-3.day, :role => "rgrgr", :visible_zip => false
user3 = User.create! :email => "feffeff@t-online.de", :encrypted_password => "gsgsgsgs", :name => "grdgdrg", :user_type => true, :sex => false, :address => "ragkagr nrgsjg grgdg 454"   , :addressN => 2, :addressE => 4, :zipcode => 456, :phone => 4564, :instantmessenger => "grggrsg", :city => "rggrrg", :email_notifications => true, :visible_phone => false, :visible_email => true, :visible_address => false, :visible_age => true, :visible_im => true, :visible_cars => false, :birthday => Time.now, :role => "grrggr", :visible_zip => true
user4 = User.create! :email => "fefafnf@aol.com", :encrypted_password => "rgrggsgr", :name => "rggdgd", :user_type => true, :sex => false, :address => "ragkagr nrgsjg grgdg 454"   , :addressN => 32, :addressE => 56, :zipcode => 793131676, :phone => 5646464564, :instantmessenger => "rgrsdgsaqwrqq", :city => "rgsgrsg", :email_notifications => true, :visible_phone => true, :visible_email => false, :visible_address => true, :visible_age => false, :visible_im => true, :visible_cars => false, :birthday => Time.now, :role => "rggggrsgs", :visible_zip => false
user5 = User.create! :email => "admin@gmx.com", :encrypted_password => "rgsgrdgrgrd", :name => "grgrdgg", :user_type => true, :sex => false, :address => "ragkagr nrgsjg grgdg 454"   , :addressN => 51, :addressE => 32, :zipcode => 12312, :phone => 4564646, :instantmessenger => "rdgrgdrg", :city => "grwewgsb", :email_notifications => true, :visible_phone => false, :visible_email => true, :visible_address => false, :visible_age => true, :visible_im => false, :visible_cars => true, :birthday => false, :role => "grgsg", :visible_zip => true
