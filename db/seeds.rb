...
user2 = User.create! :email => "mibloemer@uos.de", :password => "mibloemer",:password_confirmation => "mibloemer", :name => "Michael Blömer", :user_type => false, :sex => true, :address => "Alfred-Delp-Str. 30"   , :addressN => 52.26419, :addressE => 8.014429999999999, :zipcode => 49080, :phone => 456465, :instantmessenger => "icq: 4564644", :city => "Osnabrück", :email_notifications => false, :visible_phone => true, :visible_email => false, :visible_address => false, :visible_age => true, :visible_im => false, :visible_cars => true, :birthday => Date.new(1990,6,6), :visible_zip => false
...
req4 = Request.create! :starts_at_N => 53.553813, :starts_at_E => 9.91586, :ends_at_N => Geocoder.coordinates("Berlin")[1], :ends_at_E => Geocoder.coordinates("Berlin")[2], :address_start => "Hamburg", :address_end => "Berlin", :start_time => Time.now-1.day, :end_time => Time.now+365.day, :baggage => false, :comment => "Hilfe", :user_id => 4
req5 = Request.create! :starts_at_N => Geocoder.coordinates("48496")[1], :starts_at_E => Geocoder.coordinates("48496")[2], :ends_at_N => 45, :ends_at_E => 65, :address_start => "Rheine", :address_end => "Hopsten-Halverde", :start_time => Time.now-1.day, :end_time => Time.now+365.day, :baggage => true, :comment => "Hilfe", :user_id => 5

#Creates trips
tri1 = Trip.create! :user_id => 1, :car_id => 1, :starts_at_N => Geocoder.coordinates("Hafenbahn 10 48431")[1], :starts_at_E => Geocoder.coordinates("Hafenbahn 10 48431")[2], :ends_at_E => Geocoder.coordinates("Großer Esch 20 48496")[1], :ends_at_N => Geocoder.coordinates("Großer Esch 20 48496")[2], :address_start => "Hafenbahn 10 48431 Rheine", :address_end => "Großer Esch 20 48496 Hopsten", :start_time => Time.now-1.day, :comment => "Biete eine Fahrt an!", :baggage => true, :free_seats => 5
tri2 = Trip.create! :user_id => 2, :car_id => 2, :starts_at_N => Geocoder.coordinates("München")[1], :starts_at_E => Geocoder.coordinates("München")[2], :ends_at_E => Geocoder.coordinates("Bremen")[1], :ends_at_N => Geocoder.coordinates("Bremen")[2],:address_start => "München"   , :address_end => "Bremen"   , :start_time => Time.now-1.day, :comment => "Platz für alle :D!", :baggage => true, :free_seats => 4
tri3 = Trip.create! :user_id => 3, :car_id => 3, :starts_at_N => Geocoder.coordinates("Hamburg")[1], :starts_at_E => Geocoder.coordinates("Hamburg")[2], :ends_at_E => Geocoder.coordinates("Berlin")[1], :ends_at_N => Geocoder.coordinates("Berlin")[2], :address_start => "Hamburg"   , :address_end => "Berlin", :start_time => Time.now-1.day, :comment => "Ahoi", :baggage => false, :free_seats => 3
tri4 = Trip.create! :user_id => 4, :car_id => 4, :starts_at_N => Geocoder.coordinates("Rheine")[1], :starts_at_E => Geocoder.coordinates("Rheine")[2], :ends_at_E => Geocoder.coordinates("Lingen")[1], :ends_at_N => Geocoder.coordinates("Lingen")[2], :address_start => "Rheine"   , :address_end => "Lingen", :start_time => Time.now-1.day, :comment => "Boom Boom", :baggage => true, :free_seats => 5
tri5 = Trip.create! :user_id => 5, :car_id => 5, :starts_at_N => Geocoder.coordinates("Meppen")[1], :starts_at_E => Geocoder.coordinates("Meppen")[2], :ends_at_E => Geocoder.coordinates("Osnabrück")[1], :ends_at_N => Geocoder.coordinates("Osnabrück")[2], :address_start => "Meppen"   , :address_end => "Osnabrück", :start_time => Time.now-1.day, :comment => "Schnell schnell!", :baggage => false, :free_seats => 4
