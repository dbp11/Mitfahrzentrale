...
#Creates trips
tri1 = Trip.create! :user_id => 1, :car_id => 1, :starts_at_N => 54, :starts_at_E => 12, :ends_at_E => 33, :ends_at_N => 32, :address_start => "aha straße 2 ahahausen 32323", :address_end => "jkgagrkjgbjkre grbjgkbgj 45646", :start_time => Time.now-1.day, :comment => "fahf", :baggage => true, :free_seats => 5
tri2 = Trip.create! :user_id => 2, :car_id => 2, :starts_at_N => 45, :starts_at_E => 13, :ends_at_E => 32, :ends_at_N => 33,:address_start => "aha straße 2 ahahausen 32323"   , :address_end => "aha straße 2 blahausen 32323"   , :start_time => Time.now-1.day, :comment => "Aha", :baggage => true, :free_seats => 4
tri3 = Trip.create! :user_id => 3, :car_id => 3, :starts_at_N => 33, :starts_at_E => 55, :ends_at_E => 11, :ends_at_N => 3, :address_start => "aha straße 2 ahahausen 32323"   , :address_end => "aha straße 2 blahausen 32323", :start_time => Time.now-1.day, :comment => "ajha", :baggage => false, :free_seats => 3
tri4 = Trip.create! :user_id => 4, :car_id => 4, :starts_at_N => 22, :starts_at_E => 65, :ends_at_E => 23, :ends_at_N => 2, :address_start => "aha straße 2 ahahausen 32323"   , :address_end => "aha straße 2 blahausen 32323", :start_time => Time.now-1.day, :comment => "feff", :baggage => true, :free_seats => 5
tri5 = Trip.create! :user_id => 5, :car_id => 5, :starts_at_N => 11, :starts_at_E => 77, :ends_at_E => 33, :ends_at_N => 1, :address_start => "aha straße 2 ahahausen 32323"   , :address_end => "aha straße 2 blahausen 32323", :start_time => Time.now-1.day, :comment => "fefe", :baggage => false, :free_seats => 4
